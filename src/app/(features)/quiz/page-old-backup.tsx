      ...
      <div className="relative min-h-screen">
        ...
        >
          ...
          >
            <div className="relative">
              <Brain className="h-14 w-14 sm:h-16 sm:w-16 lg:h-20 lg:w-20 text-purple-500 mx-auto" />
              <motion.div
                animate={{ 
                  boxShadow: [
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent">
            {t.title}
          </h1>
        ...
        >
          <div className="relative">
            ...
            <div className="relative glass-effect rounded-xl p-4 sm:p-6 border border-purple-500/30">
              <LanguageSelector
                value={language}
        ...
        >
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl sm:rounded-2xl opacity-20 blur-xl" />
            <div className="relative glass-effect rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-purple-500/30">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-3 sm:mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{t.uploadResume}</h3>
                  {isAnalyzingResume && (
                    <div className="flex items-center gap-2 text-purple-400 mt-1">
                      <Clock className="animate-spin h-3 w-3 sm:h-4 sm:w-4" />
                      <span className="text-xs sm:text-sm">{t.analyzing}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <FileUpload
                ...
                icon={<Upload className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-purple-500" />}
              />
            </div>
          </div>
        </motion.div>
        ...
        {skillAnalysis && (
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 rounded-xl sm:rounded-2xl opacity-30 blur-xl animate-pulse" />
              
              <div className="relative glass-effect rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-green-500/30">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-4 sm:mb-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-green-500 to-blue-500 flex items-center justify-center flex-shrink-0">
                    <BarChart3 className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                  </div>
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">
                    📊 {t.cvAnalysis}
                  </h3>
                </div>
        ...
        >
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl sm:rounded-2xl opacity-20 blur-xl" />
            <div className="relative glass-effect rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-purple-500/30">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                {t.selectDifficulty}
              </h3>
              <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                {skillAnalysis ? 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            {(['low', 'mid', 'high'] as QuizLevel[]).map((level) => (
              <Ripple
                ...
                onMouseDown={() => {}}
                style={{}}
                className={`p-4 sm:p-6 rounded-xl border-2 transition-all hover-scale ${
                  selectedLevel === level
              ...
              >
                <div className="text-center">
                  <Target className={`h-8 w-8 sm:h-10 sm:w-10 mx-auto mb-2 sm:mb-3 ${
                    level === 'low' ? 'text-green-500' :
                    level === 'mid' ? 'text-yellow-500' :
                    'text-red-500'
                  }`} />
                  <h4 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 capitalize">{t[level]}</h4>
        ...
        >
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl sm:rounded-2xl opacity-20 blur-xl" />
            <div className="relative glass-effect rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-blue-500/30">
          ...
          {skillAnalysis ? (
            <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
              <div className="flex items-center gap-2 mb-2">
                <CheckCircle2 className="h-4 w-4 sm:h-5 sm:w-5 text-green-500" />
                <span className="text-green-500 font-semibold text-sm sm:text-base">{t.personalizedReady}</span>
              </div>
            ...
            <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-orange-500/10 border border-orange-500/30 rounded-xl">
              <div className="flex items-center gap-2 mb-2">
                <AlertCircle className="h-4 w-4 sm:h-5 sm:w-5 text-orange-500" />
                <span className="text-orange-500 font-semibold text-sm sm:text-base">{t.standardMode}</span>
              </div>
              <p className="text-gray-300 text-xs sm:text-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6">
            <div className="text-center p-3 sm:p-4 bg-purple-500/10 rounded-xl border border-purple-500/30">
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-500">20</p>
              <p className="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2">{t.totalQuestions}</p>
            </div>
            <div className="text-center p-3 sm:p-4 bg-green-500/10 rounded-xl border border-green-500/30">
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-500">
                {selectedLevel === 'low' ? '12-14' : selectedLevel === 'mid' ? '6-8' : '2-4'}
              </p>
              <p className="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2">{t.easyQuestions}</p>
            </div>
            <div className="text-center p-3 sm:p-4 bg-yellow-500/10 rounded-xl border border-yellow-500/30">
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-yellow-500">
                {selectedLevel === 'low' ? '4-6' : selectedLevel === 'mid' ? '8-10' : '6-8'}
              </p>
              <p className="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2">{t.mediumQuestions}</p>
            </div>
            <div className="text-center p-3 sm:p-4 bg-red-500/10 rounded-xl border border-red-500/30">
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-red-500">
                {selectedLevel === 'low' ? '2-4' : selectedLevel === 'mid' ? '4-6' : '12-14'}
              </p>
              <p className="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2">{t.hardQuestions}</p>
            </div>
          </div>
            </div>
          </div>
        ...
        >
          <Ripple
            ...
            className="btn-neon text-white px-6 sm:px-8 lg:px-12 py-5 sm:py-6 lg:py-8 text-base sm:text-lg lg:text-xl rounded-xl sm:rounded-2xl animate-pulse-glow w-full sm:w-auto"
            style={{}}
            onMouseDown={() => {}}
          >
            {isLoadingQuestions ? (
              <>
                <Clock className="animate-spin mr-2 sm:mr-3 h-5 w-5 sm:h-6 sm:w-6" />
                <span className="hidden sm:inline">{t.loadingQuestions}</span>
