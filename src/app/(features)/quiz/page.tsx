...
export default function EnhancedQuizPage() {
  ...
  const generateCareerInsights = (field: CareerField | null, score: number) => {
    ...
    return {
      ...
      salaryRange: typeof field.avgSalary === 'string'
        ? field.avgSalary
        : `${field.avgSalary.min} - ${field.avgSalary.max} ${field.avgSalary.currency}`,
  ...
  return (
    <div className="relative min-h-full">
      ...
      <div className="relative z-10 flex flex-col min-h-full">
        ...
        {/* Step Content */}
        <div className="flex-1 px-4 sm:px-6 py-4 pb-24">
        ...
        {/* Bottom Navigation - only for setup steps - Sticky at bottom */}
        {currentStep !== 'quiz' && currentStep !== 'result' && (
          <div className="sticky bottom-0 left-0 right-0 p-4 sm:p-6 border-t border-gray-700/50 bg-gray-900/90 backdrop-blur-md z-20">
            <div className="max-w-5xl mx-auto flex items-center justify-between">
              {/* Back Button */}
              <Button
                variant="ghost"
