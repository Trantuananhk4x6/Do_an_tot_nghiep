...
const Page = () => {
  ...
  return (
    <>
      <NeuralNetworkBg />
      <div className="relative z-10 flex flex-col lg:flex-row gap-4 lg:gap-6 min-h-full p-3 sm:p-4 lg:p-6 overflow-y-auto custom-scrollbar">
      ...
      <div className="flex flex-col space-y-3 sm:space-y-4 lg:w-1/2">
        ...
        {/* Transcript Section */}
        <div className="glass-effect flex flex-col rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-white/10 min-h-[200px]">
          <h2 className="text-sm sm:text-base font-medium gradient-text mb-2 sm:mb-3 flex items-center gap-2 flex-shrink-0">
          ...
          >
            <div className={`bg-white/5 backdrop-blur-sm p-3 sm:p-4 rounded-lg sm:rounded-xl border min-h-[150px] transition-all duration-300 ${
              mode === "manual" && selectedText 
                ? "border-purple-500/50 shadow-lg shadow-purple-500/20" 
                : "border-white/10"
            }`}>
              <div className="text-gray-300 leading-relaxed text-sm sm:text-base whitespace-pre-wrap" style={{ userSelect: mode === "manual" ? "text" : "none" }}>
                {transcript}
              </div>
            </div>
          </div>
      ...
      <div className="glass-effect rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/10 lg:w-1/2 min-h-[300px]">
